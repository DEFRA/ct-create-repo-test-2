...
```bash
docker build --target development --no-cache --tag ct-create-repo-test-2:development .
```

Run:

```bash
docker run -p 3000:3000 ct-create-repo-test-2:development
```
...
```bash
docker build --no-cache --tag ct-create-repo-test-2 .
```

Run:

```bash
docker run -p 3000:3000 ct-create-repo-test-2
```
